    ...
    <div class="container-fluid">
            ...
            <br>
                ...
                <ul class="alerts-list" style="display:none;" id="show">
                    <li>
                        <div class="alert alert-success alert-dismissable">
                            <i class="icon-remove-sign"></i> تمت الاضافة
                ...
                <ul class="alerts-list" style="display:none;" id="showupdate">
                    <li>
                      <div class="alert alert-success alert-dismissable">
                            <i class="icon-remove-sign"></i> تم تحديث البيانات بنجـــــــــاح!.
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                      </div>
                    </li>
                  </ul>
                  ...
                  <div class="widget-content-white glossed">
		                  <div class="padded">
				                    <table id="countries" class="table table-striped table-bordered table-hover datatable">
                                                ...
                                                <th class="col-md-1">السعر الصغير</th>
                                                <th class="col-md-1">السعر الوسط</th>
                                                <th class="col-md-1">السعر الكبير</th>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i>اضافة جديد</h4>
                                  </div>
                                  <form role="form"  method="POST" class="addForm" action="{{ url('/item/store') }}" data-toggle="validator"  enctype="multipart/form-data" >
                      ...
                      <div class="modal fade" id="editcountryModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <form role="form"  method="POST" class="editForm" data-id="" action="{{ url('/item/update') }}" data-toggle="validator" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        @include('item.form')
                                      </div>
                                      <div class="modal-footer">
		...
		function populateForm(response, frm)
    {
						...
						$.ajax({
								...
								success: function(res){
		 		                     ...
		 		                     $('.alerts-list').append(
		 		                         '<li>\
		 		                             <div class="alert alert-success alert-dismissable">\
		 		                                 <i class="icon-check-sign"></i> تمت الاضافة!\
		 		                                 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>\
		 		                             </div>\
		 		                         </li>');
												oTable.ajax.reload();
       ...
       //Edit Form
           ...
           $('.editForm')[0].reset();
		         ...
		         self.button('loading');
		         $.ajax({
		             url: "{{ url('item') }}" + "/" + self.data('id') + "/edit" ,
		             type: "GET",
		             success: function(res){
		                 self.button('reset');
