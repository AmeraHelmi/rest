...
<body>
  ...
  <div class="container">
      ...
      <div id='cssmenu' style="margin-left:400px;">
          <ul>
              <li class='active'><a href='{{ url('/auth/login') }}'><span style="color: black;font-size: 27px;font-weight: bold;">تسجيل دخول</span></a></li>
              <li><a href='{{ url('/auth/register') }}'><span style="color: black;font-size: 27px;font-weight: bold;">التسجيل</span></a></li>
          </ul>
      </div>
  </div>
 </header>
 <div id="wowslider-container1">
      <div class="ws_images">
          <ul>
              <li>
                  <img src="{{ asset('/admin-ui/assets/img/3.jpg')}}" alt="" title="" id="wows1_0"/>
              </li>
              <li>
